...
/// @details No se utiliza color, primitive,packet; tampoco funciones draw para primitivos.
...
/// \defgroup  Debug Debug: Visualizar qwords.
...
void print_qword(qword_t x)
{
	print_bytes(&x, sizeof(x));
}

void print_dword(u64 x)
{
	print_bytes(&x, sizeof(x));
}
/// @} 
...
/// \defgroup GS GS: Iniciar GS y entorno gráfico(v1).
