...
/// @file  main.c
/// @brief  Mostrar   triangle strip  usando  un  mínimo  de funciones de ps2sdk.
...
qword_t *draw_triangle_strip(qword_t *q)
{
    int red = 255;
    int green = 0;
    int blue = 255;
    ...
    // Giftag
    PACK_GIFTAG(q, GIF_SET_TAG(10, 0, 0, 0, 0, 1), GIF_REG_AD);
    q++;
    // primitive data
